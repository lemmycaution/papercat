...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.mount("body", "pc-app", { api: api });
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag("pc-app", "\n  <pc-header view=\"{ view }\"></pc-header>\n  <div class=\"py4 main { 'bg-white': view === 'form'}\"></div>\n  <pc-dock></pc-dock>\n  ", function (opts) {
	  ...
	  this.on("update", function () {
	    if (_this.view && _this.resource) {
	      var tag = _this.view === "index" ? "pc-" + _this.view : "pc-" + _this.resource + "-" + _this.view;
	      _this.tags.main = riot.mount(".main", tag, { api: opts.api, resource: _this.resource, navigate: _this.navigate, id: _this.id })[0];
	    }
	  });
	  ...
	  riot.route("/*", function (resource) {
	    _this.update({ view: "index", resource: resource, id: null });
	    opts.api.request("get", resource);
	  });
	
	  riot.route("/*/new", function (resource) {
	    _this.update({ view: "form", resource: resource, id: null });
	  });
	
	  riot.route("/*/*/edit", function (resource, id) {
	    _this.update({ view: "form", resource: resource, id: id });
	  });
	
	  opts.api.on("request.error.404", function () {
	    return riot.route("/");
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag("pc-index", "\n  <h1 class=\"caps center\">{ opts.resource }</h1>\n  <h3 class=\"center m2 p2\" if=\"{ !collection || collection.length === 0 }\">You don not have any { opts.resource } yet.<br><a class=\"mt2 btn btn-primary\" href=\"{ opts.resource }/new\" onclick=\"{ opts.navigate }\">Create New</a></h3>\n  <div class=\"clearfix p2\"><pc-thumb each=\"{ collection }\"></pc-thumb></div>\n  ", function (opts) {
	  ...
	  var onRequestSuccess = function (collection) {
	    return _this.update({ collection: collection });
	  };
	  this.on("mount", function () {
	    return opts.api.on("request.success", onRequestSuccess);
	  });
	  this.on("before-unmount", function () {
	    return opts.api.off("request.success", onRequestSuccess);
	  });
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CodeMirror = _interopRequire(__webpack_require__(11));
	...
	riot.mixin("setValueByNameMixin", {
	  setValueByName: function setValueByName(e) {
	    var input = e.currentTarget;
	    this.parent.record[input.name] = input.type === "checkbox" ? input.checked : input.type === "radio" ? input.selected : input.value;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(11), __webpack_require__(13), __webpack_require__(14), __webpack_require__(15));
	  else if (typeof define == "function" && define.amd) // AMD
